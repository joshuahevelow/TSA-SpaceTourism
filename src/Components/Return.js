    ...
    <>
      <div id='return-bg'>
          ...
          <div className='return-box' style={{backgroundColor: 'rgba(50, 47, 64, 0.5)'}}>
            <h1 id='return-title' style={{transform: 'translateY(-2vh)', textDecoration: 'underline', letterSpacing: '10px'}}>YOUR TRIP</h1>
            <h4 id='return-subtitle' style={{transform: 'translateY(-10vh)'}}>LAUNCH & RECOVERY</h4>
          </div>
